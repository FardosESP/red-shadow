--[[
    ...
    Captures all server events in real-time for analysis
    
    This runs CLIENT-SIDE in FiveM and captures events as they happen.
    Data is saved to JSON for Python analysis.
]]
...
-- Check if event is a job/mission event
